        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('pengaduankonsul.update', $jadwal->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="form-group">
                                <label class="font-weight-bold">Nama korban</label>
                                <input type="text" class="form-control @error('nama_korban') is-invalid @enderror" name="nama_korban" value = "{{ old('nama_korban', $jadwal->nama_korban)}}" placeholder="Masukkan nama diajukan">
                                @error('nama_korban')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ old('tanggal', $jadwal->tanggal) }}" placeholder="isi summary">
                                @error('jadwal')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('pukul') is-invalid @enderror" name="pukul" value="{{ old('pukul', $jadwal->pukul) }}" placeholder="Summary ditulis oleh">
                                @error('pukul')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
